...
import VirtualFittingResultPage from "./pages/VirtualFittingResultPage/VirtualFittingResultPage"
      ...
      <AuthProvider>
        <Router>
          ...
          <Routes>
            ...
            <Route path="/virtual-fitting/try/:clothingId" element={<VirtualFittingPage />} />
            <Route path="/virtual-fitting-main" element={<VirtualFittingMainPage />} />
            <Route path="/virtual-fitting-result/:processId" element={<VirtualFittingResultPage />} />
            <Route path="/virtual-fitting-result/saved/:fittingId" element={<VirtualFittingResultPage />} />
